...
function Header() {
  ...
  return (
    <div className="flex py-4 lg:py-6 lg:px-10 px-5 text-black justify-between">
      <h1 className="text-lg lg:text-2xl font-semibold self-center">Diagnosys Assist</h1>
